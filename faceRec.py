...
def faceRecognition(imgLoc):
    ...
    face_cascade = cv2.CascadeClassifier(r"C:\Users\Admin\OneDrive\Desktop\idp\idp\haarcascade_frontalface_default.xml")
    ...
    while True:
        ...
        if counter == 100:
            os.chdir(r'C:\Users\Admin\OneDrive\Desktop\idp\idp\images')
