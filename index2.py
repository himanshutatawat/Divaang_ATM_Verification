...
MODEL_FILE = r"C:\Users\Admin\OneDrive\Desktop\idp\idp\voice_auth_model_cnn\saved_model.pb"
...
def recognize_from_voice():
    ...
    with mic as source:
        ...
        file = r"C:\Users\Admin\OneDrive\Desktop\idp\idp\enroll1.wav"
        ...
        if min(list(distances.values()))<p.THRESHOLD:
            ...
            say("Your face has been verified")
            return 1
...
dir=r"C:\Users\Admin\OneDrive\Desktop\idp\idp\images"
...
if img_name in images:
    ...
    imgLoc = r"C:\Users\Admin\OneDrive\Desktop\idp\idp\images\{}".format(img_name)
